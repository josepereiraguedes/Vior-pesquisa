...
export const SURVEY_QUESTIONS: Question[] = [
  {
    ...
    options: [
      { id: 'makeup', label: 'Maquiagem', emoji: '💄', image: 'https://picsum.photos/400/300?random=1' },
      { id: 'skincare', label: 'Skincare', emoji: '🧴', image: 'https://picsum.photos/400/300?random=2' },
      { id: 'accessories', label: 'Acessórios', emoji: '💍', image: 'https://picsum.photos/400/300?random=3' },
      { id: 'perfume', label: 'Perfumes', emoji: '✨', image: 'https://picsum.photos/400/300?random=4' },
    ],
    required: true,
  },
  {
  ...
  },
  {
    ...
    options: [
      { id: 'shopee', label: 'Shopee / Shein', emoji: '🛍️' },
      { id: 'instagram', label: 'Lojas no Instagram', emoji: '📸' },
      { id: 'amazon', label: 'Amazon / Mercado Livre', emoji: '📦' },
...
export const MOCK_RESPONSES: CompletedSurvey[] = Array.from({ length: 50 }).map((_, i) => ({
  ...
  responses: [
    ...
    { questionId: 'location', answer: ['shopee', 'instagram'] },
